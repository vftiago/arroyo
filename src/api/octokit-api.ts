...
export const DEFAULT_OWNER = "lightradius";
...
export type OrganizationRepositories = {
  organization: {
    repositories: {
...
export const getRepositoryData = async (): Promise<OrganizationRepositories> => {
  const repositoryData = await graphqlWithAuth<OrganizationRepositories>({
    query: /* GraphQL */ `
