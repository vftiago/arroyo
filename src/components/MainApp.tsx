...
import { OrganizationRepositories, getRepositoryData } from "../api/octokit-api";
...
const MainApp = ({ weightedHeaders }: { weightedHeaders: WeightedTable<string>[] }) => {
  ...
  const [repositoryData, setRepositoryData] = useState<OrganizationRepositories | null>(null);
