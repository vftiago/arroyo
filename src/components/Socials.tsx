...
const Socials = () => {
  ...
  return (
    ...
    >
      <div className="flex h-10 w-[290px] pb-12">
        <span id="toast"></span>
      </div>
      <div className="flex w-full items-center justify-center gap-20">
        <Clicky>
          <motion.a
            ...
            rel="noreferrer"
          >
            <GithubIcon customStyles="fill-white transition duration-500 ease-out-expo" />
          </motion.a>
        </Clicky>

        <Clicky onClick={handleMailIconClick}>
          <motion.a className="h-9 hover:cursor-pointer" variants={item} rel="noreferrer">
            <MailIcon customStyles="fill-white transition duration-500 ease-out-expo" />
          </motion.a>
        </Clicky>
        ...
        <Clicky>
          <motion.a
            className="h-9 hover:cursor-pointer"
            variants={item}
            href="https://linkedin.com/company/lightradius/about"
            target="_blank"
            rel="noreferrer"
          >
            <LinkedinIcon customStyles="fill-white transition duration-500 ease-out-expo" />
          </motion.a>
        </Clicky>
      </div>
    </motion.div>
